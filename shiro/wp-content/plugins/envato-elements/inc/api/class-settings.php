	...
	public function get_server_limits() {
		...
		try {
			...
			$limits['upload'] = [
				...
				'message' => $upload_max_filesize_ok ? "is ok at '$upload_max_filesize_in_mb'." : "$upload_max_filesize_in_mb is too small. Please set your PHP upload limits to at least $upload_size_desiredM - or ask your hosting provider to do this if you're unsure.",
			];
		} catch ( \Exception $e ) {
			$limits['upload'] = [
				'title'   => 'PHP Upload Limits',
